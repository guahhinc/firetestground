var SV = "1.0.5", selP = !1, selT = 0, J, L, M, q = require("device"), W = require("display"), z = require("keyboard"), K = require("storage"), V = require("wifi"), _ = { black: W.color(0, 0, 0), grey: W.color(127, 127, 127), white: W.color(255, 255, 255), green: W.color(0, 255, 0), yellow: W.color(255, 255, 0), orange: W.color(255, 165, 0), red: W.color(255, 0, 0), cyan: W.color(0, 255, 255), blue: W.color(0, 0, 255), light_blue: W.color(100, 200, 255) }, H = "http://ghp.iceis.co.uk", Q = H + "/service/main/releases/categories.json", X = "/BruceJS/", Y = "/Themes/", _IR = "/BruceIR/", Z = "/GuahhStore/installed.json", $ = "/GuahhStore/cache/", ee = "/GuahhStore/lastUpdated.json", te = [], re = [], se = {}, ne = {}, ae = [], oe = 0, ie = 0, ce = 0, le = "categories", ge = null, ue = !1, pe = !1, he = !1, fe = !1, de = !1, ve = "", ye = 0, me = 0, we = 0, Te = 0, be = [], Ce = "littlefs", xe = !1, Ee = !1, Ae = !1, Se = W.width(), Pe = W.height(), Ne = Se > 300 ? 1 : 0, Ge = Math.trunc(Se / (6 * (Ne + 1))), Re = 8 * (1 + Ne), Ue = 10 * (2 + Ne); for (e(), E(), T(), J = !1, L = "", M = ""; !ue;) {
  ...
  if (z.getEscPress()) if (de) d(); else { if ("scripts" !== le) { ue = !0;
